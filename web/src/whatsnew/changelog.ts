...
export const CHANGELOG: ChangelogRelease[] = [
  {
    ...
    items: [
      {
        emoji: '📂',
        text: "The Library is in sections like a creator's page - each with an icon, and each folds.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        emoji: '🌿',
        text: 'The library keeps itself organized: tidy names, and new recordings enhanced on their own.',
      },
      { emoji: '🍃', text: 'Calmer lists, and one short "Needs a look" list for the admin.' },
    ],
  },
  {
    version: '0.36.0',
  ...
  },
  {
    ...
    items: [
      {
        emoji: '📚',
        text: "Courses of several modules now sit with the courses on a creator's page.",
      },
    ],
  },
  {
