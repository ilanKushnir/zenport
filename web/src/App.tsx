...
import { SitPage } from './pages/SitPage.tsx';
        ...
        <InboxProvider>
          <Shell>
            <Routes>
              ...
              <Route path="/ai/guide" element={<GuidePage />} />
              <Route path="/ai/discover" element={<DiscoverPage />} />
              <Route path="/ai/sit" element={<SitPage />} />
